About langchain-nomic-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/langchain-nomic-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/langchain-nomic-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add langchain-nomic
# for installing globally
pixi global install langchain-nomic
```
...
It is possible to list all of the versions of `langchain-nomic` available on your platform:
...
```
pixi search langchain-nomic --channel conda-forge
```
